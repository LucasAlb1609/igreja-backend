...
from .models import ConfiguracaoSite, Departamento, SecaoLideranca, Pessoa, DiaSemana, Evento, EventoEspecial, Devocional, Pastor, Memorial
...
# A linha original foi corrigida para registrar apenas um modelo.
# O modelo 'Devocional' já é registrado abaixo com o decorator.
...
class DiaSemanaAdmin(admin.ModelAdmin):
    # Agora apenas exibimos o nome e o resumo, e permitimos adicionar eventos
    list_display = ('get_nome_display', 'resumo')
    inlines = [EventoInline]

    # Função auxiliar para exibir o nome bonito na lista
...
# Registrando os novos modelos para que apareçam no Admin
